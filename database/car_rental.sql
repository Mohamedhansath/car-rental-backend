...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 11, 2026 at 03:55 PM
...
CREATE TABLE `bookings` (
  ...
  `car_name` varchar(100) DEFAULT '',
  `car_type` varchar(50) DEFAULT '',
  `car_image` text DEFAULT '',
  `car_brand` varchar(50) DEFAULT '',
  `pickup` varchar(100) DEFAULT 'Chennai',
  `drop_loc` varchar(100) DEFAULT 'Chennai',
...
--
ALTER TABLE `bookings`
  ADD CONSTRAINT `bookings_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user_register` (`id`) ON DELETE CASCADE,
